...
class OrderItemUserController extends Controller
{
    public function view($order_id)
    {
        return view('dashboard.order.order_item_user', compact('order_id'));
    }

    public function getdata(Request $request, $order_id)
    {
