                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4 mb-3">
                                <input name="product_id" id="search-product_id" class="form-control"
                            ...
                            <div class="col-md-4 mb-3">
                                <input type="number" name="quantity" id="search-quantity" class="form-control"
                                    placeholder="@lang('general.quantity')">
                                <div class="invalid-feedback"></div>
                            </div>
                            {{-- السعر --}}

                            <div class="col-md-4 mb-3">
                                <input type="number" step="0.01" name="price" id="search-price" class="form-control"
            ...
            <div class="col-12 col-lg-12 col-xl-12 d-flex">
                <div class="card radius-10 w-100">
                    <div class="card-header bg-transparent">
                        <div class="row g-3 align-items-center">
                            <div class="col">
                                <h5 class="mb-0">@lang('general.all_order-item')</h5>
                            </div>
                            <div class="col">
...
@section('js')
    <script>
        var table = $('#datatable').DataTable({
            ...
            ajax: {
                url: "{{ route('ecommerce.dash.Order-item-user.getdata', $order_id) }}",
                data: function(d) {
